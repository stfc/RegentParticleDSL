...
local __demand(__leaf) task pairwise_task([parts1], [parts2], [config] )
  ...
  reads(parts1.core_part_space.{pos_x, pos_y, cutoff}),
...
local __demand(__leaf) task asym_pairwise_task([parts1], [parts2], [config] )
  where [read1_privs], [read2_privs], [read3_privs], [write1_privs], [reduc1_privs], [reduc3_privs], reads(config.space), reads(parts1.core_part_space.{pos_x, pos_y, cutoff}),
  reads(parts2.core_part_space.{pos_x, pos_y, cutoff}), reads(parts1.neighbour_part_space._valid), reads(parts2.neighbour_part_space._valid),
  [coherences] do
   var box_x = config[0].space.dim_x
   var box_y = config[0].space.dim_y
...
local __demand(__leaf) task self_task([parts1], [config]) where
  [read1_privs], [readconf_privs], [write1_privs], [reduc1_privs], [reducconf_privs], reads(parts1.core_part_space.{pos_x, pos_y, cutoff}),
